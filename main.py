...
class GhostShell:
    ...
    def run(self):
            ...
            while True:
                ...
                if move:
                    try:
                        ...
                        self.prev_map = None  # TODO: Implement get_board_piece_map  # Initialize prev_map
                        break
                    except ValueError:
        ...
        if not hasattr(self, 'prev_map'):
            self.prev_map = None  # TODO: Implement get_board_piece_map
        ...
        while not self.board.is_game_over():
            ...
            if self.board.turn == self.user_side:
                ...
                if best_move_uci:
                    ...
                    self.prev_map = None  # TODO: Implement get_board_piece_map  # Update prev_map after our move
                ...
                if detected is None:
                    ...
                    for attempt in range(10):  # retry a few times
                        prev_map = None  # TODO: Implement get_board_piece_map if not hasattr(self, 'prev_map') else self.prev_map
                    ...
                    while True:
                        ...
                        try:
                            self.board.push_uci(move)
                            self.prev_map = None  # TODO: Implement get_board_piece_map  # Update prev_map
                            break
                        except ValueError:
                            self.logger.error(f"Invalid move: {move}")
